           ...
           tic;
            ...
            elseif strcmp(dataSource, 'learnDataset')
                ...
                for lag = -RandomForestMethod.maxlag:RandomForestMethod.maxlag
                    this.X = [this.X, NS3.Data(35:40, (RandomForestMethod.maxlag*100+lag*100+1):100:(end-RandomForestMethod.maxlag*100+lag*100))', events(:, (RandomForestMethod.maxlag+lag+1):(end-RandomForestMethod.maxlag+lag))'];
                end
