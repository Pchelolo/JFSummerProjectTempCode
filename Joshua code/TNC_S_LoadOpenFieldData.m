...
fileDirectory = 'C:\Users\loaner\Documents\Data\DAmouseOpenField\'
...
for k = 1:numFiles
    ...
    data.year = fileNameBase(strfind(fileNameBase,'201'):strfind(fileNameBase,'201')+3);
    data.month = fileNameBase(strfind(fileNameBase,'201')+4:strfind(fileNameBase,'201')+5);
    data.day = fileNameBase(strfind(fileNameBase, '201')+6:strfind(fileNameBase,'201')+7);
